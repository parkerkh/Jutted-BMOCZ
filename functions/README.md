...
- `getTemplate()`: get J-BMOCZ template given a zero constellation
...
**Note:** we do not claim for the functions to be well written or thoroughly commented. Nevertheless, we hope that you find them interesting and useful.